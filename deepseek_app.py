...
with st.sidebar:
    ...
    selected_model = st.selectbox(
        "Choose Model", ["deepseek-r1-distill-qwen-7b"], index=0
    )
    st.divider()
    ...
    st.divider()
    st.markdown(
        "Built with [LM Studio](https://lmstudio.ai/) | [LangChain](https://python.langchain.com/)"
    )
...
def generate_ai_response(prompt_chain):
    ...
    data = {
        "model": selected_model,  # Usa el modelo seleccionado
